...
export interface Page {
	...
	Offset: number  // Optional offset. Number of matching messages to skip. Useful for jumping directly to a specific page number when AnchorMessageID is not known.
}
...
export interface Settings {
	...
	WebmailUnreadStyle: string  // WebmailUnreadStyle: "", "bar" (default), "bold", "barbold", "tint", "dot".
...
export const types: TypenameMap = {
	...
	"Page": {"Name":"Page","Docs":"","Fields":[{"Name":"AnchorMessageID","Docs":"","Typewords":["int64"]},{"Name":"Count","Docs":"","Typewords":["int32"]},{"Name":"DestMessageID","Docs":"","Typewords":["int64"]},{"Name":"Offset","Docs":"","Typewords":["int32"]}]},
