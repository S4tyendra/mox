...
type Settings struct {
	...
	WebmailListDateStyle    string // Date in the message list.
	WebmailViewSenderStyle  string // Sender in the reading pane.

	// WebmailUnreadStyle: "", "bar" (default), "bold", "barbold", "tint", "dot".
