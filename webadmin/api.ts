...
export interface Msg {
	...
	SMTPUTF8: boolean  // Whether message requires use of SMTPUTF8, e.g. for non-ASCII in headers.
	SMTPUTF8Addr: boolean  // Whether envelope addresses (MAIL FROM/RCPT TO localparts) contain non-ASCII characters. Cannot be downgraded.
...
export interface MsgRetired {
	...
	SMTPUTF8Addr: boolean  // Whether envelope addresses contain non-ASCII characters.
	IsDMARCReport: boolean  // Delivery failures for DMARC reports are handled differently.
	IsTLSReport: boolean  // Delivery failures for TLS reports are handled differently.
	Size: number  // Full size of message, combined MsgPrefix with contents of message file.
